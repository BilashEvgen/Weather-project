...
class WeatherContainer(widgets.QFrame):
    def __init__(self, parent):
        ...
        self.LEFT_MOMENT_LAYOUT.addWidget(self.LEFT_MOMENT_TOP_FRAME)
        # Внутри left moment weather frame
        self.LEFT_CITY_LABEL = widgets.QLabel(self.LEFT_MOMENT_FRAME)
        self.LEFT_CITY_LABEL.setStyleSheet("color: white; font-size: 44px; border-radius: 0px;background-color: transparent;")
        self.LEFT_CITY_LABEL.setFixedSize(145, 52)
        ...
        self.LEFT_WETHER_ICON = widgets.QLabel(self.LEFT_WEATHER_FRAME)
        self.LEFT_WETHER_ICON.setFixedSize(84, 87)
        self.LEFT_WETHER_ICON.setStyleSheet("border-radius: 0px;")
        self.LEFT_WEATHER_LAYOUT.addWidget(self.LEFT_WETHER_ICON)
        # Внутри left weather frame
        self.LEFT_WEATHER_LABEL = widgets.QLabel(self.LEFT_WEATHER_FRAME)
        self.LEFT_WEATHER_LABEL.setFixedSize(113, 87)
        self.LEFT_WEATHER_LABEL.setStyleSheet("color: white; font-size: 74  px;border-radius: 0px;background-color: transparent;")
        ...
        self.LEFT_DESCRIPTION_LAYOUT.setAlignment(core.Qt.AlignmentFlag.AlignTop)
        # Внутри left description frame
        self.LEFT_DESCRIPTION_LABEL1 = widgets.QLabel(self.LEFT_DESCRIPTION_FRAME)
        self.LEFT_DESCRIPTION_LABEL1.setFixedSize(87, 28)
        self.LEFT_DESCRIPTION_LABEL1.setStyleSheet("color: white; font-size: 24px; border-radius: 0px;background-color: transparent;")
        self.LEFT_DESCRIPTION_LAYOUT.addWidget(self.LEFT_DESCRIPTION_LABEL1, alignment = core.Qt.AlignmentFlag.AlignCenter)
        # Внутри left description frame
        self.LEFT_DESCRIPTION_LABEL2 = widgets.QLabel(self.LEFT_DESCRIPTION_FRAME)
        self.LEFT_DESCRIPTION_LABEL2.setFixedSize(130, 19)
        self.LEFT_DESCRIPTION_LABEL2.setStyleSheet("color: white; font-size: 16px; border-radius: 0px;background-color: transparent;")
        self.LEFT_DESCRIPTION_LAYOUT.addWidget(self.LEFT_DESCRIPTION_LABEL2, alignment = core.Qt.AlignmentFlag.AlignCenter)
        ...
        self.RIGHT_TODAY_FRAME.setStyleSheet("border-radius: 0px;background-color: transparent;")
        ...
        self.RIGHT_TODAY_LABEL.setStyleSheet("color: white; font-size: 16px; border-radius: 0px;background-color: transparent;")
        ...
        self.RIGHT_DATA_LABEL1.setStyleSheet("color: white; font-size: 24px; border-radius: 0px;background-color: transparent;")
        ...
        self.RIGHT_DATA_LABEL2.setStyleSheet("color: white; font-size: 24px; border-radius: 0px;background-color: transparent;")
        self.RIGHT_DATA_LAYOUT.addWidget(self.RIGHT_DATA_LABEL2, alignment = core.Qt.AlignmentFlag.AlignRight)
        # Внутри right moment frame
        self.RIGHT_CLOCK_FRAME = widgets.QFrame(self.RIGHT_MOMENT_FRAME)
        ...
        self.RIGHT_CLOCK_LABEL.setStyleSheet("color: white; font-size: 29px; border-radius: 0px;background-color: transparent;")
